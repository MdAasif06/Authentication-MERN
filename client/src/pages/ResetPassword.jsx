...
const ResetPassword = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-200 to bg-purple-400">
      <img
        onClick={() => navigate("/")}
        src={assets.logo}
        alt="logo"
      ...
      {/* otp input  form */}
      {!isOtpSubmitted && isEmailSent && <form onSubmit={onSubmitOtp}
          className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm"
        >
          <h1 className="text-white text-2xl font-semibold text-center mb-4">
            Reset Password OTP
          ...
          <p className="text-center mb-6 text-indigo-300">
            Enter the 6-digit code sent your email id
          </p>
          ...
          <button
            className="w-full py-2 bg-gradient-to-r from-indigo-500 to-indigo-900
