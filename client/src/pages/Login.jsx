...
const Login = () => {
  ...
  return (
    <div
      ...
      sm:px-0 bg-gradient-to-br from-blue-200 to bg-purple-400"
    >
      <img
        onClick={() => navigate("/")}
        src={assets.logo}
        ...
        <form onSubmit={onSubmithandler}>
          ...
          {state === "Sign Up" && (
            <div
             ...
             rounded-full bg-[#333A5C] text-white"
            >
          ...
          <button
            ...
            from-indigo-400 to-indigo-800 text-white font-semibold cursor-pointer"
          >
            {state}
          </button>
        </form>
